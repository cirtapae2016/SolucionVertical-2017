...
namespace LOGICA_DE_NEGOCIOS
{
    ...
    public class clsCodificacion
    {
        public string clave = "#Proyecto-Desarrollo_Felipe_Pablo_Hector-2016#"; // Clave de cifrado.
        ...
        public string[] cortalicencia(string vLicencia)
        {
            String value = vLicencia;

            string[] lines = Regex.Split(value, "##");

            string[] parts = value.Split(lines,
